...
<Callout type="info">For cloud instances, email will be sent from `noreply@nocodb.com` Self-hosted instances require configuring an SMTP server in the NocoDB settings to enable email sending.</Callout>
