...
## [**Table & Field Permissions** : Control access—exactly how you need it](https://nocodb.com/docs/product-docs/roles-and-permissions/table-permissions)
...
## [**Record colouring** : Turn data into insight—instantly!](https://nocodb.com/docs/product-docs/table-operations/record-colouring)
...
## [**Scripts** (beta) : Power of JavaScript, right in your workspace!](https://nocodb.com/docs/scripts)
...
## [**Webhook v3** : Smarter triggers, cleaner automation](https://nocodb.com/docs/product-docs/automation/webhook)
...
## [**API v3** (beta) : Fewer calls, cleaner design](https://data-apis-v3.nocodb.com/)
