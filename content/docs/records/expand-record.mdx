...
<Callout type="info">Any changes made to the links field (link/unlink) will be saved automatically</Callout>
...
<Callout type="info">@mentions & comments resolve feature is only supported in cloud hosted / self-hosted enterprise plans</Callout>
...
<Callout type="info">File Preview Mode is only available in cloud hosted / self-hosted enterprise plans</Callout>
...
<Callout type="info">Discussion Mode is only available in cloud hosted / self-hosted enterprise plans</Callout>
