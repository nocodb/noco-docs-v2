...
<Callout type="note">
The Extensions feature is available exclusively on NocoDB on-premise deployments. The feature will be made available on NocoDB Cloud in the future.
</Callout>
...
- [Extension Marketplace](overview#extensions-marketplace)

- [Adding Extensions](overview#adding-extensions)

- [Managing Extensions](overview#managing-extensions)
