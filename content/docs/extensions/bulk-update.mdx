...
Bulk updates affect all records within the current view, including those not visible on the screen. These updates are limited to the selected view and do not impact records outside of it or in other views.
