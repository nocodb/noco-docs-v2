...
4. Select `Base Type` : Default / Private.
   ...
   - **Private**: This base type allows for granular control over access, independent of workspace roles. Only the base creator will have access by default, and other members must be explicitly granted access. Learn more about [Private Base](/bases/private-base).
