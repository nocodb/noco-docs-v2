...
In NocoDB, bases are the foundational elements that encompass tables, views, forms, and webhooks, providing a structured framework for data organization and collaborative work. Each base is inherently tied to a specific workspace and cannot be transferred between different workspaces. The creator of a base is designated as the 'base owner'. A base can have multiple owners, each with the authority to manage the base settings and access permissions. At least one owner is required for each base for it to remain operational.
...
To get started, you can [create an empty base](/docs/product-docs/bases/create-base) if you want to start from scratch. If you've already been using Airtable, we make it easy to [import your base](/docs/product-docs/bases/import-base-from-airtable). When collaborating with your team, you can [invite them](/docs/product-docs/bases/base-collaboration) to work on a base together. If you want to share your data with a broader audience, you can [make your base public](/docs/product-docs/bases/share-base). If you ever need to rename your base, you can do so by using the [rename base](/docs/product-docs/bases/actions-on-base#rename-base) feature. And, if you find a base especially useful, you can [bookmark it](/docs/product-docs/bases/actions-on-base#star-base) for quick access. However, when the time comes to remove a base, you can [delete it](/docs/product-docs/bases/actions-on-base#delete-base).
...
[Base Collaborations](/docs/product-docs/bases/base-collaboration) section.
...
for additional details on this feature, which will be covered in the forthcoming [Data Sources](/docs/product-docs/data-sources) section. 
