...
Views are customized ways of displaying your data. You can [create multiple views](/docs/product-docs/views/create-view) for each table in your base, and each view can have its own set of fields, filters, and layouts. NocoDB offers a variety of view types for custom display, including [Grid](/docs/product-docs/views/view-types/grid), [Kanban](/docs/product-docs/views/view-types/kanban), and [Gallery](/docs/product-docs/views/view-types/gallery). If you are collecting data from a form, you can also create a [Form view](/docs/product-docs/views/view-types/form) to display the data in a form format.
