...
## Cell display
Cells in a **URL** field display the web address as a clickable link. Clicking the link will open the URL in a new browser tab.

![image](/img/v2/fields/types/url/cell-display.png)
