...
Each cell displays its rating using the icon style and color configured for the field.
![image](/img/v2/fields/types/rating/cell-display.png)

### Setting a value

You can set a rating value in any of the following ways:

* Click the desired rating icon (`n-th` icon) to set the value to `n`.
* Type a rating value directly into the cell.
* Paste a rating value into the cell.

### Clearing a value

You can clear the rating value using any of the following methods:

* Click the selected rating icon again to reset the value to `0`.
* Type `0` in the cell.
* Press `Delete` to reset the value to `0`.
