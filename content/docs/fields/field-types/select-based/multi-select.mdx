...
A new option can be added directly from the cell by typing into the cell and pressing `Enter`. This action automatically appends the value to the field’s option list.

![image](/img/v2/fields/types/select-based/option-in-cell-add.png)
---
