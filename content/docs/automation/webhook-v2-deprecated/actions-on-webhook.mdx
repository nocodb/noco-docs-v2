...
- This will open up the webhook configuration page, which is similar to the page used for [creating webhook](/automation/webhook-v2/create-webhook). Reconfigure the webhook as required
