...
<Callout type="info">Collaboration related Meta APIs are available on NocoDB Cloud Business+ plans and Self-hosted Enterprise plans. View & Script related Meta APIs are available on NocoDB Cloud and Self-hosted Enterprise plans.</Callout>
