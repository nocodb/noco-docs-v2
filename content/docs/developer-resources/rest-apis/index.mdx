...
<Callout type="info">**Advanced** Meta APIs related to View, Script and Collaboration features are available only on NocoDB Cloud Business+ plans and Self-hosted Enterprise editions.</Callout>
