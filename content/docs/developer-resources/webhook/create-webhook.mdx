...
<Tabs items={["After Insert", "After Update", "After Delete", "After Bulk Insert", "After Bulk Update", "After Bulk Delete"]}>
<Tab value="After Insert" label="After Insert">
...
<Tab value="After Update" label="After Update">
