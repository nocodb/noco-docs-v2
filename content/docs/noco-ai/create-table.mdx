...
1. Click **+ Create Table**  
   From the left sidebar, select **+ Create Table** under the table section.
...
- Explore **Relationship Diagrams (ERD)** to understand how your data connects
- Add **Forms, Automations, and Extensions** to build complete workflows
