...
1. Add a **Formula Field**
    ...
    In your table, click **+ Add Field** and select **Formula** as the type.
...
- Sort or filter by calculated values
- Use formulas in view configurations or forms
- Combine them with other AI-powered features for advanced automation
