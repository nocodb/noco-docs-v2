...
Table ID can be retrieved from the URL when you are viewing the table. The table ID has prefix `m` (represents model) and is a unique identifier for the table within the base.

Sample URL
```
https://app.nocodb.com/#/wqd7e84kkpg8169/pqh6trao813gar7/mxo5v3uj1l1xjpz
```
The table ID in this example is `mxo5v3uj1l1xjpz`.

Table context menu also provides the option to copy the table ID to clipboard.
