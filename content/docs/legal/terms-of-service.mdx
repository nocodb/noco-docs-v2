...
THIS AGREEMENT APPLIES TO YOUR USE OF THE SERVICES, TOGETHER WITH YOUR ORDER (MADE ONLINE OR BY ORDER FORM), AND THE NOCODB PRIVACY POLICY WHICH IS INCORPORATED BY REFERENCE: https://nocodb.com/privacy/.
...
We will use commercially reasonable efforts to provide basic support via the Our Discourse channel for support to You or Your designated Customer contacts during Our ordinary business hours, unless otherwise set forth in Your Order.

### b. Security

We shall maintain administrative, physical, and technical safeguards for protection of the security, confidentiality, and integrity of Your Customer Data, in accordance with NocoDB's Data Privacy Policy available at https://nocodb.com/privacy/ and incorporated by reference.
