...
description: 'View NocoDB's Service Level Agreement (SLA) outlining uptime commitments, definitions of downtime, and eligibility for service credits for Enterprise plan customers.'
---

**Last Updated: August 05, 2025**

NocoDB provides a 99.9% uptime commitment for active customers on our Enterprise plans (and certain Business plan customers who have agreed to NocoDB’s [Master Subscription Agreement](/docs/product-docs/legal/msa)), subject to the terms below.
...
## Definitions
Any capitalized terms not defined in this Service Level Agreement have the meanings given to them in NocoDB’s [Master Subscription Agreement](/docs/product-docs/legal/msa) (the "MSA"). References to the “Services” in this Service Level Agreement also mean the “NocoDB Products” (or similar term), as used in the MSA.
