...
NocoDB provides a 99.9% uptime commitment for active customers on our Enterprise and Enterprise Scale plans (and certain Business plan customers who have agreed to NocoDB’s Master Subscription Agreement), subject to the terms below.
...
Definitions
Any capitalized terms not defined in this Service Level Agreement have the meanings given to them in NocoDB’s Master Subscription Agreement (the "MSA"). References to the “Services” in this Service Level Agreement also mean the “NocoDB Products” (or similar term), as used in the MSA.
