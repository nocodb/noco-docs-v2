...
NocoDB Inc, doing business as NocoDB ("we," "our," "us," or "NocoDB"), prepared this Privacy Policy to help you understand our practices with respect to the collection, use, and disclosure of information we collect from you through: (i) nocodb.com, its subdomains, and any other website where our Terms of Service are posted; (ii) our online hosted services; and (iii) our "Software," meaning, collectively, application programming interfaces ("APIs"), and tools and documentation ((i) through (iii) collectively, our or the "Services").
