...
![Lock view message](/img/v2/views/lock-view/lock-message.png)
![Unlock view message](/img/v2/views/lock-view/unlock-message.png)

Locked views in sidebar appears with a `lock` icon next to the view name.
![Locked view sidebar](/img/v2/views/lock-view/locked-view-in-sidebar.png)
...
![Personal view](/img/v2/views/lock-view/view-permission-change.png)

You can also assign or change the owner of a Personal View from the left sidebar view context menu.

![Change personal view owner](/img/v2/views/personal-view/assign-as-personal-view.png)
![Change personal view owner](/img/v2/views/personal-view/assign-as-personal-view-2.png)

Personal view in sidebar appears with a `user` icon next to the view name.
![Personal view sidebar](/img/v2/views/personal-view/personal-view-in-sidebar.png)
