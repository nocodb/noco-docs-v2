...
Selective "Copy from another view" menu option is also available for various toolbar items like Filter, Group and Sort.
...
<div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem', maxWidth: '400px'}}>
    <div>
        ![Copy view configuration - Group](/img/v2/views/copy-from-another-view/group-by-menu.png)
    </div>
    <div>
        ![Copy view configuration - Sort](/img/v2/views/copy-from-another-view/sort-menu.png)
    </div>
</div>
