...
<Callout type="info">Note that, the custom URL is case-sensitive.</Callout>
...
<Callout type="info">Filters & sorts applied to shared view will not be persisted. These filters & sorts will be reset when the shared view is accessed again.</Callout>
