...
2. [Show or Hide Fields Within the Gallery](/docs/product-docs/table-operations/field-operations#showhide-fields)
...
7. [Change Cover Image](/docs/product-docs/table-operations/field-operations#change-cover-field-gallerykanban-view) 
