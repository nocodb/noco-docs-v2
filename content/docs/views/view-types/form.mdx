...
## Form View Actions
1. [Create a New Form View](/docs/product-docs/views/create-view#create-new-view)
2. [Rename an Existing Form View](/docs/product-docs/views/actions-on-view#rename-view)
3. [Duplicate a Form View](/docs/product-docs/views/actions-on-view#duplicate-view)
4. [Remove a Form View](/docs/product-docs/views/actions-on-view#delete-view)
5. [Share a Form View](/docs/product-docs/views/share-view)
6. [Lock Form View for Edits](/docs/product-docs/views#view-permission-types)
...
<Callout type="info">Formatting options are supported for the description field. You can also use Markdown to format the text</Callout>
...
<Callout type="info">This feature is available only in the paid plans in both Cloud & Self-hosted</Callout>
...
<Callout type="info">Formatting options are supported for the `After Submit Message` field. You can also use Markdown to format the text</Callout>
...
<Callout type="info">Use of Redirect URL is mutually exclusive with the `After Submit missage`, `Show a Blank form` and `Submit Another Form` options. If Redirect URL is enabled, the form will redirect to the specified URL after submission</Callout>
...
<Callout type="info">Formatting options are supported for the `Help Text` field. You can also use Markdown to format the text</Callout>
...
<Callout type="info">Field validations are only available in the cloud version of NocoDB</Callout>
...
<Callout type="info">In any of the modes, the user can still change the prefilled fields by editing the URL</Callout>

## Survey Form View
NocoDB supports a special type of form view called `Survey Form View`. This view is ideal for creating surveys & questionnaires. This view can be enabled by toggling the `Survey Mode` switch when creating [shared form view](/docs/product-docs/views/share-view#share-form-view-options). 
...
## Related articles
[Form View](/docs/product-docs/views/view-types/grid)  
