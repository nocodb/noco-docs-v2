...
## Kanban View Actions
1. [Create a New Kanban View](/docs/product-docs/views/create-view#create-new-view)
2. [Rename an Existing Kanban View](/docs/product-docs/views/actions-on-view#rename-view)
3. [Duplicate a Kanban View](/docs/product-docs/views/actions-on-view#duplicate-view)
4. [Remove a Kanban View](/docs/product-docs/views/actions-on-view#delete-view)
5. [Share a Kanban View](/docs/product-docs/views/share-view)
6. [Lock Kanban View for Edits](/docs/product-docs/views#view-permission-types)

## Kanban View Operations
1. [Rearrange Fields Within the Kanban](/docs/product-docs/table-operations/field-operations#rearranging-fields)
2. [Show or Hide Fields Within the Kanban](/docs/product-docs/table-operations/field-operations#showhide-fields)
3. [Apply Filters to Display Specific Records on the Kanban](/docs/product-docs/table-operations/filter)
4. [Sort Records on the Kanban by One or More Criteria](/docs/product-docs/table-operations/sort)
