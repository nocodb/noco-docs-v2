...
1. [Create a New Calendar View](/docs/product-docs/views/create-view#create-new-view)
2. [Rename an Existing Calendar View](/docs/product-docs/views/actions-on-view#rename-view)
3. [Duplicate a Calendar View](/docs/product-docs/views/actions-on-view#duplicate-view)
4. [Remove a Calendar View](/docs/product-docs/views/actions-on-view#delete-view)
5. [Share a Calendar View](/docs/product-docs/views/share-view)
6. [Lock Calendar View for Edits](/docs/product-docs/views#view-permission-types)
...
<Callout type="info">The date range for the calendar view is supported only in the Cloud version of NocoDB</Callout>
...
<Callout type="info">The date range configuration is currently supported only for the Date field type. Support for DateTime field type will be added in the future</Callout>
...
1. [Apply Filters to Display Specific Records on the Calendar](/docs/product-docs/table-operations/filter)
2. [Sort Records on the Calendar by One or More Criteria](/docs/product-docs/table-operations/sort)
3. [Perform Quick Searches for Specific Data Within Fields](/docs/product-docs/table-operations/search)
4. [Export Data to CSV or Excel Format](/docs/product-docs/table-operations/download#download-data)
