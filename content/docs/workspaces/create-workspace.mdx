...
Then you have the ability to either [modify its name](/docs/product-docs/workspaces/actions-on-workspace#rename-workspace) or creating an entirely new workspace.
...
Once your workspace is set up, you can [create tables](/docs/product-docs/tables/create-table) and [invite others](/docs/product-docs/workspaces/workspace-collaboration) to join and work together. 
