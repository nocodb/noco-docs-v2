...
Select fields allow users to choose one or more options from a predefined list. These are ideal for statuses, tags, categories, or any other repeatable classifications.
