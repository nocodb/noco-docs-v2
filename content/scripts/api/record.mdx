...
```javascript
// LinkToAnotherRecord (many-to-one relationship)
...
// LinkToAnotherRecord (many-to-many relationship)
const team = record.getCellValue('Team Members'); // Array of NocoDBRecord objects or empty array
...
// For many-to-many/has-many: returns count as number
