...
- `options` (optional): Object with the following properties:
  ...
  - `limit` (`number`): Maximum number of records to return (default: 500)
...
**Returns:** `Promise<Record | null>` - A promise that resolves to the Record object or null if not found or filtered out by the view
