...
slug: 'sub-processors'
description: 'List of third-party Sub-processors engaged by NocoDB, including their roles and locations, to support service delivery and data processing.'
---
...
*Only for customers using NocoAI.
