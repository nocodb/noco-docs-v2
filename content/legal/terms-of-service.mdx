...
We make available features and functionality within the Services that utilize generative artificial intelligence models ("NocoAI"). Your use of NocoAI is subject to these Terms and the [NocoAI Terms](/docs/legal/ai-terms), which are available at [www.nocodb.com/ai-terms](/docs/legal/ai-terms) and are incorporated into these Terms by reference. The NocoAI Terms may be updated from time to time.
