---
title: 'EU DSA'
slug: 'eu-dsa-disclosures'
description: 'Learn about NocoDB’s EU Digital Services Act (DSA) disclosures, including our compliance measures, transparency obligations, and user rights under the regulation.'
---
...
For information on the restrictions that apply to content on the Services and how we enforce violations of these restrictions, please see our [Acceptable Use Policy](/docs/legal/aup).

## Tools Used for Content Moderation
We use a combination of technology and human review to evaluate compliance with our Service Terms, including our [Acceptable Use Policy](/docs/legal/aup).  Where Your Content or an NocoDB account is flagged for human review, our review team evaluates the content or account and the reasons it was flagged and makes a decision as to whether to take action on it.  We then use technology and human effort to remove content and accounts that we determine to be in violation of the applicable agreement or our [Acceptable Use Policy](/docs/legal/aup).  If we make a decision to remove Your Content, suspend or terminate your account, or take other actions, we will notify you as required by the DSA.
